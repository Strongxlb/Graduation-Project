...
| B2  | Rossman, Woo, Tryby, Shang, Janke, Haxton (2020). EPANET 2.2 User Manual. *US EPA*.                                                                                                                 | [https://www.epa.gov/water-research/epanet](https://www.epa.gov/water-research/epanet) | EPANET 数值方法            | P1  |     |     |     | 余氯传输方程权威参考。                                                        |
| B3  | Klise et al. (2018). Water Network Tool for Resilience (WNTR) User Manual. *Sandia / EPA*.                                                                                                          | [https://wntr.readthedocs.io](https://wntr.readthedocs.io)                             | WNTR API               | P1  |     |     |     | 写 Methodology 时引用。                                                 |

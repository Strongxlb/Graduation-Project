...
> **配套脚本**
> - 修改版（Demo 1）：[`../../src/01_demo_wntr.py`](../../src/01_demo_wntr.py) → `figures/week1_demo/`、`results/week1_demo/`
> - 原始版（Demo 2）：[`../../src/02_demo_wntr_original.py`](../../src/02_demo_wntr_original.py) → `figures/week1_original/`、`results/week1_original/`
> - 对比汇总：同上脚本 Step (d) → `figures/week1_compare/`、`results/week1_compare/`
>
...
| **路径** | `REPO_ROOT`, `FIG_DIR`, `RES_DIR` | 定义并创建 `figures/week1_demo/`、`results/week1_demo/`、`models/` | 目录 |
...
[out]   Figures written to .../figures/week1_demo
[out]   CSVs written to .../results/week1_demo
```
...
| 代码块 | 函数 / 位置 | 做了什么 | 输出 / 副作用 |
| --- | --- | --- | --- |
| **路径** | `FIG_ORIG`, `RES_ORIG`, `FIG_CMP`, `RES_CMP` | 创建 `week1_original/`、`week1_compare/` | 目录 |
...
| **④ 原始产物** | `plot_original_outputs()` | 与 Demo 1 **同结构** 4 图 + 2 CSV，但氯图含 **全部 9 节点** | `figures/week1_original/`、`results/week1_original/` |
| **⑤ 读 Demo 1** | `make_comparison()` | 读取 `results/week1_demo/chlorine_junctions.csv`（**必须先跑 01**） | — |
| **⑥ 对比图** | `make_comparison()` | 左/右并排时序；24 h 空间快照（统一色标） | `figures/week1_compare/` 2 PNG |
...
| 脚本 | 图（`figures/`） | 表（`results/`） |
| --- | --- | --- |
| **01** | `week1_demo/01_network.png` … `04_chlorine_spatial.png` | `week1_demo/chlorine_junctions.csv`、`pressure_junctions.csv` |
| **02** | `week1_original/` 同上四张；`week1_compare/chlorine_timeseries_side_by_side.png`、`spatial_at_24h.png` | `week1_original/` 同上两 CSV；`week1_compare/summary_per_node.csv`、`summary_overall.csv` |
...
> 输出目录：`figures/week1_demo/`、`results/week1_demo/`
...
来源：[`chlorine_junctions.csv`](../../results/week1_demo/chlorine_junctions.csv)
...
> 输出目录：`figures/week1_original/`、`results/week1_original/`
...
来源：[`chlorine_junctions.csv`](../../results/week1_original/chlorine_junctions.csv)
...
> 输出目录：`figures/week1_compare/`、`results/week1_compare/`
...
来源：[`summary_overall.csv`](../../results/week1_compare/summary_overall.csv)、[`summary_per_node.csv`](../../results/week1_compare/summary_per_node.csv)
...
| 目录 | 内容 |
| --- | --- |
| `figures/week1_demo/` | Demo 1：`01_network.png` … `04_chlorine_spatial.png` |
| `figures/week1_original/` | 原始版：同上四张图 |
| `figures/week1_compare/` | `chlorine_timeseries_side_by_side.png`、`spatial_at_24h.png` |
| `results/week1_demo/` | `chlorine_junctions.csv`、`pressure_junctions.csv` |
| `results/week1_original/` | 同上 |
| `results/week1_compare/` | `summary_per_node.csv`、`summary_overall.csv` |
